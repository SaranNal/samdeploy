...
def builddeployArtifact(source_artifact, environmentName, deploymentData):
    ...
    containerNames = {'saran-api': '', 'saran-admin-portal': '', 'saran-app-portal': ''}
...
def replace_placeholder_and_create_artifacts(containerImages, environmentName):
    ...
    post_to_teams('API image - ' + containerImages['saran-api'], environmentName)
    post_to_teams('Admin Portal image - ' + containerImages['saran-admin-portal'] , environmentName)
    post_to_teams('App Portal image - ' + containerImages['saran-app-portal'] , environmentName)
...
def get_running_prod_image(containerNames, environmentName):
    ...
    valid_containers = ['saran-api', 'saran-admin-portal', 'saran-app-portal']
